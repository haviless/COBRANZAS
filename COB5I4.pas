...
type
  TFRepCtaSinResolucion = class(TForm)
    Panel1: TPanel;
    zzzzz: TPanel;
    GroupBox1: TGroupBox;
...
var
  FRepCtaSinResolucion: TFRepCtaSinResolucion;

implementation

{$R *.DFM}

procedure TFRepCtaSinResolucion.fcShapeBtn2Click(Sender: TObject);
begin
Self.Close;
end;

procedure TFRepCtaSinResolucion.fcShapeBtn1Click(Sender: TObject);
begin
ppResCtaIndivSinResol.Print;
end;

procedure TFRepCtaSinResolucion.ppResCtaIndivSinResolPreviewFormCreate(
  Sender: TObject);
begin
// , ppViewr
