object FRepCtasCanceladas: TFRepCtasCanceladas
  Left = 215
  Top = 211
  ...
  object pnlCabecera: TPanel
    ...
    Color = 10207162
    TabOrder = 0
    object FCuotasNoDesc: TLabel
      Left = 16
      Top = -2
      Width = 287
      Height = 27
      Caption = 'Cuentas Canceladas / Vigiladas'
      Font.Charset = ANSI_CHARSET
      Font.Color = clNavy
      Font.Height = -19
      Font.Name = 'Comic Sans MS'
  ...
  object ppRepCtasCanceladas: TppReport
    ...
    DeviceType = 'Screen'
    OnPreviewFormCreate = ppRepCtasCanceladasPreviewFormCreate
