...
type
  TFRepDetCtaIndconFec = class(TForm)
    Panel1: TPanel;
    zzzzz: TPanel;
    GroupBox1: TGroupBox;
...
var
  FRepDetCtaIndconFec: TFRepDetCtaIndconFec;

implementation

{$R *.DFM}

procedure TFRepDetCtaIndconFec.fcShapeBtn1Click(Sender: TObject);
begin
ppResCtaIndivConResol.Print;
end;

procedure TFRepDetCtaIndconFec.fcShapeBtn2Click(Sender: TObject);
begin
Self.Close;
end;

procedure TFRepDetCtaIndconFec.ppResCtaIndivConResolPreviewFormCreate(
  Sender: TObject);
begin
// , ppViewr
