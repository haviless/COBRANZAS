object FGeneracionOficios: TFGeneracionOficios
  Left = 183
  Top = 115
  ...
  object pnlCabecera: TPanel
    ...
    object Panel2: TPanel
      ...
      ParentFont = False
      TabOrder = 1
      object dbeCodigoReclamo: TwwDBEdit
        Left = 6
        Top = 5
        Width = 145
        Height = 21
    ...
    object Panel3: TPanel
      ...
      object TLabel
        ...
        Width = 122
        Height = 15
        Caption = 'N'#176' Cuenta de Asociados'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
  ...
  object ppRepOficioGiro: TppReport
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'RepOficioGiro'
    ...
    object ppHeaderBand3: TppHeaderBand
      ...
      object ppMemo4: TppMemo
        UserName = 'Memo4'
        Caption = 
          '    Por medio de la presente, agradecemos se sirvan transferir a' +
          ' las CUENTAS DE AHORRO, seg'#250'n relaci'#243'n cargando el monto de la o' +
          'peraci'#243'n a nuestra Cuenta Corriente 0000-3905 a los siguientes b' +
          'eneficiarios:'#13#10
        CharWrap = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        ...
        Lines.Strings = (
            ...
            '        Agradecemos se sirva transferir a la  Cuenta de Ahorro I' +
            'ndividual de las personas que indicamos a continuaci'#243'n, cargando' +
            ' el monto de la operaci'#243'n m'#225's comisiones a nuestra Cuenta Corrie' +
            'nte N'#176' 000-003905')
        Transparent = True
        mmHeight = 16933
        mmLeft = 10583
        mmTop = 95956
