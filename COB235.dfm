object FSolConFallecidos: TFSolConFallecidos
  Left = 171
  Top = 128
  Width = 800
  Height = 545
  BorderWidth = 3
  Caption = 'Solicitud de Confirmaci'#243'n de Fallecidos'
  Color = 10207162
  ...
  object pInferior: TPanel
    ...
    object btnModSolicitud: TButton
      Left = 318
      Top = 9
      Width = 130
      Height = 28
      Caption = 'Modificar Solicitud'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object dbgPrincipal: TwwDBGrid
    ...
    object dbgPrincipalButton: TwwIButton
      Left = 0
      Top = 0
      Width = 30
      Height = 30
      ...
      NumGlyphs = 2
      OnClick = dbgPrincipalButtonClick
    end
  end
  object gbx1: TGroupBox
    ...
    object rgbusca: TRadioGroup
      ...
      Width = 371
      Height = 41
      Caption = 'Buscar Solicitudes de Confirmaci'#243'n de Fallecidos'
      Color = 10207162
      Columns = 3
    ...
    object cboEstado: TwwDBLookupCombo
      Left = 89
      Top = 78
      Width = 288
      Height = 21
