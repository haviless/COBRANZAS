object FRepEvalCxC: TFRepEvalCxC
  Left = 216
  Top = 85
  ...
  object pnlFondo16: TPanel
    ...
    object Label1: TLabel
      ...
      Align = alTop
      Alignment = taCenter
      Caption = 'Evaluaci'#243'n y Calificaci'#243'n de Cartera de Cta. por Cobrar'
      Font.Charset = ANSI_CHARSET
      Font.Color = clNavy
      Font.Height = -13
      Font.Name = 'Comic Sans MS'
    ...
    object Z2bbtnProceso: TfcShapeBtn
      Left = 151
      Top = 122
      Width = 32
      Height = 31
    ...
    object Z2bbtnCuadro: TfcShapeBtn
      Left = 189
      Top = 122
      Width = 32
      Height = 31
      ...
      TextOptions.Alignment = taCenter
      TextOptions.VAlignment = vaVCenter
      OnClick = Z2bbtnCuadroClick
    end
    object Z2bbtnResumen: TfcShapeBtn
      Left = 229
      Top = 122
      Width = 32
      Height = 31
      ...
      TextOptions.Alignment = taCenter
      TextOptions.VAlignment = vaVCenter
      OnClick = Z2bbtnResumenClick
    end
    object Z2bbtnDetalle: TfcShapeBtn
      Left = 269
      Top = 122
      Width = 32
      Height = 31
      ...
      TextOptions.Alignment = taCenter
      TextOptions.VAlignment = vaVCenter
      OnClick = Z2bbtnDetalleClick
    end
  end
  object ppRepEvalCxC: TppReport
    AutoStop = False
    DataPipeline = bdepEvalua
    ...
    Template.FileName = 'C:\SOLExes\SolFormatos\Cob\Dema\CARTERA1.rtm'
    DeviceType = 'Screen'
    OnPreviewFormCreate = ppRepEvalCxCPreviewFormCreate
    ...
    object ppTitleBand1: TppTitleBand
      ...
      object ppLabel7: TppLabel
        UserName = 'Label7'
        Caption = 'Resum'#233'n De Calificaci'#243'n De Cartera a '
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Courier New'
        Font.Size = 14
      ...
      object dbtFechaCar1: TppDBText
        UserName = 'dbtFechaCar1'
        AutoSize = True
        DataField = 'FECHA'
        DataPipeline = bdepEvalua
        Font.Charset = ANSI_CHARSET
    ...
    object ppDetailBand2: TppDetailBand
      ...
      mmHeight = 4498
      mmPrintPosition = 0
      object dbtResuCar1: TppDBText
        UserName = 'dbtResuCar1'
        DataField = 'RESUID'
        DataPipeline = bdepEvalua
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
      ...
      object dbtResudesCar1: TppDBText
        UserName = 'dbtResudesCar1'
        AutoSize = True
        DataField = 'RESUDES'
        DataPipeline = bdepEvalua
        Font.Charset = ANSI_CHARSET
      ...
      object dbtTtalCuoCar1: TppDBText
        UserName = 'dbtTtalCuoCar1'
        AutoSize = True
        DataField = 'TOTALCUO'
        DataPipeline = bdepEvalua
        DisplayFormat = '###,###,##0'
      ...
      object dbtMontoCar1: TppDBText
        UserName = 'dbtMontoCar1'
        AutoSize = True
        DataField = 'MONTOS'
        DataPipeline = bdepEvalua
        DisplayFormat = '###,###,##0.00'
    ...
    object ppSummaryBand2: TppSummaryBand
      ...
      object dbcTotalCuoCar1: TppDBCalc
        UserName = 'dbcTotalCuoCar1'
        AutoSize = True
        DataField = 'TOTALCUO'
        DataPipeline = bdepEvalua
        DisplayFormat = '###,###,##0.00'
      ...
      object dbcMontoCar1: TppDBCalc
        UserName = 'dbcMontoCar1'
        AutoSize = True
        DataField = 'MONTOS'
        DataPipeline = bdepEvalua
        DisplayFormat = '###,###,##0.00'
  ...
  object bdepEvalua: TppBDEPipeline
    UserName = 'bdepEvalua'
    Left = 20
    Top = 28
  end
  object bdepCab: TppBDEPipeline
    UserName = 'bdepCab'
    Left = 196
    Top = 36
  end
  object bdepDet: TppBDEPipeline
    UserName = 'bdepDet'
    Left = 276
    Top = 44
  end
  object ppRepEval: TppReport
    AutoStop = False
    DataPipeline = bdepCab
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    PrinterSetup.PaperName = 'Carta'
    PrinterSetup.PrinterName = 'Default'
    ...
    PrinterSetup.mmPaperWidth = 215900
    PrinterSetup.PaperSize = 1
    Template.FileName = 'C:\SOLExes\SolFormatos\Cob\Dema\CARTERA2.rtm'
    DeviceType = 'Screen'
    OnPreviewFormCreate = ppRepEvalCxCPreviewFormCreate
    OutlineSettings.CreateNode = True
    OutlineSettings.CreatePageNodes = True
    ...
    object ppHeaderBand3: TppHeaderBand
      ...
      object ppLabel4: TppLabel
        UserName = 'Label4'
        Caption = 'Calificaci'#243'n De Cartera al'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Courier New'
        Font.Size = 14
        ...
        object ppChildReport2: TppChildReport
          ...
          object ppHeaderBand4: TppHeaderBand
            ...
            object ppLabel21: TppLabel
              UserName = 'Label21'
              Caption = 'Descripci'#243'n de Calificaci'#243'n'
              Font.Charset = ANSI_CHARSET
              Font.Color = clBlack
              Font.Name = 'Courier New'
              Font.Size = 10
