...
begin
   ...
   dm1.cdsQry1.open;
   xSql := 'SELECT CRE302.*,'+
           'case when cre302.crebloq = ''S'' then ''BLOQUEADO'' ELSE CRE302.CREESTADO END CREESTADO1, '+
           'CRE113.FLGSALDO,CRE113.FLGSUMA FROM CRE302,CRE113 WHERE ASOID='+quotedstr(wAsoid)+
   ...
   dbgDetHistorial.Selected.Add('CREESTADO1'#9'15'#9'Estado');
